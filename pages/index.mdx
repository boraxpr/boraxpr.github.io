...
- Proficient in a **_diverse range of programming languages and frameworks_**, incl. Java, C#, C, Python, JavaScript, Bash, Kotlin, and Dart (Flutter BLoC), Vue, Nuxt, React - functional components, hooks, Next, TailwindCSS, TypeScript, and more.
